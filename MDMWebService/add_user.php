...
function adduser($data) {
    ...
    $employee_id=$first_name=$login_name=$password=$dob=$gender_id=$marital_status_id=$email=$photo=$address=$city=$state=$pincode=$country_id=$landline=$mobile=$employee_status='';
